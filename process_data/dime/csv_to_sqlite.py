...
# (https://github.com/rufuspollock/csv2sqlite/blob/master/csv2sqlite.py)
# Placed in the Public Domain
# Bug fixes by Simon Heimlicher <sh@nine.ch> marked by `shz:'s
# Slightly modified for use with DIME by Trey Connelly (https://github.com/treybc)
